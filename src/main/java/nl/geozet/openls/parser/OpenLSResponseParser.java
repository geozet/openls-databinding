...
public class OpenLSResponseParser extends DefaultHandler {
    ...
    public GeocodeResponse getGeocodeResponse() {
        ...
        if (objStack.firstElement() != null) {
            if (objStack.firstElement().getClass() == GeocodeResponse.class) {
